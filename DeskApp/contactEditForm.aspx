<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactEditForm.aspx.cs" Inherits="ImperialDeskApp.DeskApp.contactEditForm" %>
...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title>DeskApp - Contact Edit Form</title>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Contact Edit Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Contact Edit Form</h4>
                        </div>
                    </div>
                    <form runat="server">
                        <div class="form-group row">
                            <%--<label class="col-sm-12 col-md-2 col-form-label">Text</label>--%>
                            <asp:Label ID="lblName" runat="server" class="col-sm-12 col-md-2 col-form-label" Text="Name"></asp:Label>
                        ...
                        <div class="form-group row">
                            ...
                            <asp:Label ID="lblSubject" runat="server" class="col-sm-12 col-md-2 col-form-label" Text="Subject"></asp:Label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <asp:Label ID="lblMessage" runat="server" class="col-sm-12 col-md-2 col-form-label" Text="Message"></asp:Label>
                            <div class="col-sm-12 col-md-10">
                                <%--<input class="form-control" value="https://getbootstrap.com" type="url">--%>
                                <textarea id="textareaMessage" runat="server" class="form-control" rows="4"></textarea>
