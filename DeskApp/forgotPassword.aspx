<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotPassword.aspx.cs" Inherits="ImperialDeskApp.DeskApp.forgotPassword" %>
				...
				<div class="login-box bg-white box-shadow border-radius-10">
					...
					<form runat="server">
						<div class="input-group custom">
							...
							<asp:TextBox ID="txtEmail" class="form-control form-control-lg" placeholder="Email" runat="server"></asp:TextBox>
						...
						<div class="row align-items-center">
							<div class="col-5">
								<div class="input-group mb-0">
									...
									<%--<a class="btn btn-primary btn-lg btn-block" href="index.aspx">Submit</a>--%>
								</div>
							</div>
							<div class="col-2">
							...
							<div class="col-5">
								<div class="input-group mb-0">
									<a class="btn btn-outline-primary btn-lg btn-block" href="login.aspx">Login</a>
								</div>
							</div>
						</div>
					</form>
