<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ai-machine-learning.aspx.cs" Inherits="ImperialDeskApp.Imperial.ai_machine_learning" %>
    ...
    <main class="main">
        ...
        <div class="page-title dark-background">
            <div class="container position-relative">
                ...
                <p>Harness the power of AI and Machine Learning to drive innovation and efficiency.</p>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4">
                        <div class="services-list">
                            ...
                            <a href="ai-machine-learning.aspx" class="active">AI & Machine Learning</a>
                            <a href="it-consulting-support.aspx">IT Consulting & Support</a>
                        </div>
                        <h4>Our AI & Machine Learning Expertise</h4>
                        <p>Our AI and machine learning solutions enable businesses to make data-driven decisions, improve operations, and drive innovation.</p>
                    </div>
                    <div class="col-lg-8">
                        <img src="assets/img/services-ai-machine-learning.jpg" alt="AI & Machine Learning" class="img-fluid services-img"/>
                        <h3>Innovative AI & ML Solutions</h3>
                        <p>We offer advanced AI and machine learning services that help you unlock new opportunities, improve decision-making, and automate processes.</p>
                        <ul>
                            <li><i class="bi bi-check-circle"></i><span>Data-driven decision-making with predictive analytics.</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Automation of routine tasks to improve efficiency.</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Advanced machine learning models for bespoke solutions.</span></li>
                        </ul>
                        <p>Partner with us to leverage the power of AI and machine learning in your business, ensuring you stay ahead in the competitive market.</p>
                    </div>
                </div>
            </div>
        </section>
