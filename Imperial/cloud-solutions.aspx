<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cloud-solutions.aspx.cs" Inherits="ImperialDeskApp.Imperial.cloud_solutions" %>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        ...
        <div class="page-title dark-background">
            <div class="container position-relative">
                ...
                <p>Empowering your business with scalable and secure cloud solutions.</p>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4">
                        <div class="services-list">
                            ...
                            <a href="cloud-solutions.aspx" class="active">Cloud Solutions</a>
                            <a href="ai-machine-learning.aspx">AI & Machine Learning</a>
                            <a href="it-consulting-support.aspx">IT Consulting & Support</a>
                        </div>
                        <h4>Our Cloud Solutions Expertise</h4>
                        <p>We provide scalable and flexible cloud solutions that ensure your business is always ready for growth and innovation.</p>
                    </div>
                    <div class="col-lg-8">
                        <img src="assets/img/services-cloud-solutions.jpg" alt="Cloud Solutions" class="img-fluid services-img"/>
                        <h3>Scalable and Secure Cloud Services</h3>
                        <p>Our cloud solutions are designed to provide your business with scalable, flexible, and secure services that adapt to your changing needs.</p>
                        <ul>
                            <li><i class="bi bi-check-circle"></i><span>Scalable infrastructure to support your growth.</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Flexible solutions that adapt to your business needs.</span></li>
                            <li><i class="bi bi-check-circle"></i><span>Secure and reliable services for peace of mind.</span></li>
                        </ul>
                        <p>With our cloud solutions, you can focus on your core business while we manage the technology. Our solutions are crafted to ensure maximum uptime, security, and performance.</p>
                    </div>
                </div>
            </div>
        </section>
